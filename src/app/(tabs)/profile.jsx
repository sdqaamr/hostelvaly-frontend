    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.relativePosition}>
          ...
          <TouchableOpacity style={styles.profileImgEditor}>
            <AntDesign name="edit" size={20} color="white" />
          </TouchableOpacity>
        </View>
        <View style={styles.profileDetailContainer}>
          <Text style={styles.profileDetailText}>Full Name</Text>
          <Text style={styles.fontFifteen}>Siddiqa Durrani</Text>
          <View style={styles.profileDescriptionBottomLine} />
        </View>
        <View style={styles.profileDetailContainer}>
        ...
        <View style={styles.profileDetailContainer}>
          <Text style={styles.profileDetailText}>Status</Text>
          <Text style={styles.fontFifteen}>Active</Text>
          <View style={styles.profileDescriptionBottomLine} />
        </View>
        <View style={styles.profileDetailContainer}>
          <Text style={styles.profileDetailText}>Role</Text>
          <Text style={styles.fontFifteen}>Admin</Text>
          <View style={styles.profileDescriptionBottomLine} />
        </View>
        <View style={styles.profileDetailContainer}>
          <Text style={styles.profileDetailText}>Gender</Text>
          <Text style={styles.fontFifteen}>Female</Text>
          <View style={styles.profileDescriptionBottomLine} />
        </View>
        <View style={styles.profileDetailContainer}>
          <Text style={styles.profileDetailText}>Phone</Text>
          <Text style={styles.fontFifteen}>+923006208822</Text>
          <View style={styles.profileDescriptionBottomLine} />
        </View>
        <View style={styles.profileDetailContainer}>
          <Text style={styles.profileDetailText}>City</Text>
